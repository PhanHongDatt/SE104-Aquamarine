import { Settings, Shield, Wrench, ArrowLeft, Info, HelpCircle, Database } from "lucide-react";
...
export default function AdminCaiDatPage() {
  const settingsOptions = [
    ...
    },
    {
      ...
      desc: "Tạo bản sao lưu PostgreSQL và phục hồi từ file đã xác nhận",
      href: "/admin/cai-dat/sao-luu-phuc-hoi",
      icon: Database,
