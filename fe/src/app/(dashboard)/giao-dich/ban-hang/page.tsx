...
export const metadata = { title: "Phiếu Bán Hàng – Quản Lý Vàng Bạc Đá Quý" };
    ...
    <div className="page-container space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1">Tạo phiếu bán hàng cho khách hàng</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-zinc-200/80 shadow-sm p-12 text-center text-zinc-400">
        ...
        <p className="text-sm mt-1">Lập phiếu bán hàng cho khách hàng</p>
      </div>
    </div>
  );
}
