...
export const metadata = { title: "Đơn vị tính – Admin | Quản Lý Vàng Bạc Đá Quý" };
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-zinc-900">Đơn vị tính</h1>
          <p className="text-sm text-zinc-500 mt-1">Quản lý các đơn vị tính sản phẩm</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-12 flex flex-col items-center justify-center gap-3 text-center">
        ...
        <p className="text-sm font-medium text-zinc-600">Chưa có đơn vị tính nào</p>
